	...
	function readMap(icons)  {
		...
		request.open("GET", "http://www.vesseltracker.com/googleMapsServlet/owner_33270_default_op.xml?id=" + ts, true);
			...
			if (request.readyState == 4) {
				...
				for(var i = 0; i < markerElements.length; i++) {
					...
					if(markerElements[i].getAttribute("lat")!=null && markerElements[i].getAttribute("lng")!=null){
						...
						lastSeenHtml="<tr><td><br />Keine aktuelle Position.</td></tr><tr><td>Letzte empfangene<br /> Position:</td></tr><tr><td>" + markerElements[i].getAttribute("last_seen") + "</t></tr>" ;
					}
					...
					var info1 = '<div style="height:275px;width:250px;background-color:#FFFFFF;font-size:0.8em">';
